...
public class GroupActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (theme) {
            case 0: findViewById(R.id.fragment_group).setBackgroundResource(R.color.purple_2); break;
            case 1: findViewById(R.id.fragment_group).setBackgroundResource(R.color.blue_2); break;
            case 2: findViewById(R.id.fragment_group).setBackgroundResource(R.color.red_2); break;
            case 3: findViewById(R.id.fragment_group).setBackgroundResource(R.color.yellow_2); break;
            case 4: findViewById(R.id.fragment_group).setBackgroundResource(R.color.blue_6); break;
            case 5: findViewById(R.id.fragment_group).setBackgroundResource(R.color.red_4); break;
            case 6: findViewById(R.id.fragment_group).setBackgroundResource(R.color.yellow_6); break;
            case 7: findViewById(R.id.fragment_group).setBackgroundResource(R.color.gray_2); break;
        }
        initClickListener();
